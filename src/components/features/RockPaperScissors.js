...
const RockPaperScissors = ({ room, game, user, onLeaveRoom, onGameCompletion }) => {
    ...
    const fetchRoomDetails = async () => {
        try {
            ...
            const previousGameStatus = gameState.gameStatus;
            setRoomDetails(response.data);
            setGameState(response.data.gameState);
            setPlayers(response.data.players);

            // Check if game just finished and call completion handler
            if (previousGameStatus !== 'finished' && response.data.gameState.gameStatus === 'finished') {
